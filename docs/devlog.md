...
按时间顺序记录 `Micro` 的设计过程、踩坑记录和后续扩展。文章发布在知乎，微信公众号「极客投研笔记」同步更新。
...
| [我用 Hermes Agent + micro-data skill，把本地数据库变成了可对话的投研助手](https://zhuanlan.zhihu.com/p/2049206897111196557) | `micro-data` AI Skill：让智能体把中文自然语言数据请求转成本地查询流程 |
