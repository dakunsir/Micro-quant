#!/usr/bin/env python3
"""Run a Micro local pro.query call from the command line."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Query local Micro data.")
    ...
    parser.add_argument(
        ...
        help="Path to Micro settings.toml.",
    )
    parser.add_argument(
        "--head",
        type=int,
