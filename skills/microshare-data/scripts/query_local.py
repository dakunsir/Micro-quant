#!/usr/bin/env python3
"""Run a Microshare local pro.query call from the command line."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Query local Microshare data.")
    ...
    parser.add_argument(
        ...
        help="Path to Microshare settings.toml.",
    )
    parser.add_argument(
        "--head",
        type=int,
